...
const outputDir = path.join(__dirname, '../client/public/webp-images');
...
async function convertToWebP() {
  try {
    ...
    console.log(`🔄 Converting ${imageFiles.length} images to WebP in webp-images folder...`);
    ...
    console.log('🎉 Image conversion to webp-images folder completed!');
  } catch (error) {
